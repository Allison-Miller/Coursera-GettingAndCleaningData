...
Jerk: Linear acceleration and angular velocity derived in time  
Gravity: Gravity component derived from acceleration signals  
Body: Body motion component derived from acceleration signals  
Mag: Magnitude of linear acceleration and angular velocity derived in time  
f: frequency domain  
